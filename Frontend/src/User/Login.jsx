      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full text-white font-bold py-2 px-4 rounded ${loading ? "bg-gray-400" : "bg-blue-600 hover:bg-blue-700"
              }`}
          >
        ...
        <p className="mt-6 text-center text-xs border-t pt-4">
          Are you an Admin? <Link to="/admin/login" className="text-red-500 font-bold hover:underline">Admin Login</Link>
        </p>
      </div>
    </div>
  );
